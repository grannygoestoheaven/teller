...
from src.teaicher.services.generate_story import generate_story, generate_story_strict
...
def teller_ui():
    ...
    # if genre :
    #     track_path = "/Users/grannygoestoheaven/code/computer science projects/teaicher/static/audio/New_York_Sounds.mp3"
