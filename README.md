...
- The button below 'ooo' below 'teller' allows you to switch between dots (the current view), text, and grid modes.
- To listen to a new story, you can hover the text of the last generated story to select the words or subjects you're interested in, click to paste them into the form, then press Enter or start. You can also type what you want.
